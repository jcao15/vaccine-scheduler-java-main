...
public class Vaccine {
    ...
    public static class VaccineGetter {
        ...
        public ArrayList<Vaccine> getAll() throws SQLException {
            ...
            try {
                ...
                while (resultSet.next()) {
                    String vn = resultSet.getString("Name");
                    int availableDoses = resultSet.getInt("Doses");
                    VaccineBuilder vb = new VaccineBuilder(vn, availableDoses);
                    res.add(new Vaccine(vb));
                }
                return res;
            } catch (SQLException e) {
                throw new SQLException();
